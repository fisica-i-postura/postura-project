...
class KinematicsPlotHelper:
    ...
    def plot_position(self):
        ...
        fig = plot_helper(self.kinematics_data.t, ys, names, f"{self.joint_name}: Position vs Time", "Time (s)", "Position (m)", "lines", self.steps)
        ...
        fig = plot_helper(self.kinematics_data.t, ys_smooth, names, f"{self.joint_name}: Position (smooth) vs Time", "Time (s)", "Position (m)", "lines", self.steps)
        export_fig_as_png(fig, f"{self.path}/{self.joint_name}_position_smooth.png")
    ...
    def plot_velocity(self):
        ...
        fig = plot_helper(self.kinematics_data.t, ys, names, f"{self.joint_name}: Velocity vs Time", "Time (s)", "Velocity (m/s)", "lines", self.steps)
        ...
        fig = plot_helper(self.kinematics_data.t, ys_smooth, names, f"{self.joint_name}: Velocity (smooth) vs Time", "Time (s)", "Velocity (m/s)", "lines", self.steps)
        export_fig_as_png(fig, f"{self.path}/{self.joint_name}_velocity_smooth.png")
    ...
    def plot_acceleration(self):
        ...
        fig = plot_helper(self.kinematics_data.t, ys, names, f"{self.joint_name}: Acceleration vs Time", "Time (s)", "Acceleration (m/s^2)", "lines", self.steps)
        ...
        fig = plot_helper(self.kinematics_data.t, ys_smooth, names, f"{self.joint_name}: Acceleration (smooth) vs Time", "Time (s)", "Acceleration (m/s^2)", "lines", self.steps)
        export_fig_as_png(fig, f"{self.path}/{self.joint_name}_acceleration_smooth.png")
